...
class MainViewModelTest{
    ...
    fun `when Get Stories Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storiesRepository.getPagedStories()).thenReturn(expectedStory)

        val actualStory: PagingData<ListStoryItem> = mainViewModel.getPagedStories().getOrAwaitValue()
